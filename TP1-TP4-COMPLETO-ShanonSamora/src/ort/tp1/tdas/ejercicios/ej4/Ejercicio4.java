...
public class Ejercicio4 {
	...
	private static void bajaChofer(int dni) {
		try {
			...
			System.out.println("Hubo un error al intentar la baja: " + e.getMessage());
		}
	}
	...
	private static void asignarCargaAVehiculo(String descripcionCarga, double peso) {
		try {
			...
			System.out.println("ERROR EN LA ASIGNACION DE UNA CARGA");
	...
	private static void asignarVehiculo(String patente, int dniChofer) {
		try {
			...
			System.out.println("ERROR EN LA ASIGNACION DE VEHICULO A CHOFER");
			System.out.println(e.getMessage());
		}
	}
